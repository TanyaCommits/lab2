...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.plaintext1)) { v, insets ->
        ...
        submitButton.setOnClickListener{
            ...
            // Create intent to navigate to CalculatorActivity
            val intent = Intent(this, CalculatorActivity::class.java)
            // Pass the user input from the text field to the new activity
